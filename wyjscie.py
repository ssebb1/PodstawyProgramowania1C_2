...
#sposób 3.1.
print('Witaj {} {}. Masz {} lat. Za 5 lat będziesz mieć {} lat.'.format(imie,
                                                                        nazwisko, wiek, wiek + 5))

#sposób 3.2.
print('Witaj {1} {0}. Masz {3} lat. Za 5 lat będziesz mieć {2} lat.'.format(nazwisko, imie,
                                                                        wiek + 5, wiek))